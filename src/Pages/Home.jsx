  ...
  const DataGet = async () => {
    try {
      const res = await fetch(
        "https://e-commerce-backend-leqau.ondigitalocean.app/api/admin/Products/NewArival",
        {
          method: "GET",
          headers: {
      ...
      const res0 = await fetch(
        "https://e-commerce-backend-leqau.ondigitalocean.app/api/admin/Products/TopSelling",
        {
          method: "GET",
          headers: {
            Accept: "application/json",
